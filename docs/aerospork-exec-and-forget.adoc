...
credentials, anything exported by your shell profile at launch. This is deliberate: a script that
posts to Slack needs its token. But it means the config file is trusted input.

Treat a `exec-and-forget` line you copied from the internet exactly as you would treat a line you
were about to paste into your shell.
