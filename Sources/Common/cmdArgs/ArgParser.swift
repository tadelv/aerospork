...
/// Shared with the TOML parser (`parseDefaultContainerOrientation`), so a `--flag` and the config
/// key behind it list the same accepted values. Bridge to `TomlParseError` via `toParsedToml`.
